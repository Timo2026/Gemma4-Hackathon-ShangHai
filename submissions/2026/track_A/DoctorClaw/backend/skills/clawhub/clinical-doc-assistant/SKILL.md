...
optionalEnv:
  ...
  - LLM_API_KEY          # Required server-side if you self-host backend.py. Uses Gemma 4 via OpenAI-compatible API.
---
...
|---------|------------|--------------------------------------|
| 1.0.5   | 2026-06-08 | Backend uses Gemma 4 API (`LLM_API_KEY`). |
| 1.0.4   | 2026-03-29 | Added CORS production warning. |
